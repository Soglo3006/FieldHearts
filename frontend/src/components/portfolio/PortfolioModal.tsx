      ...
      {showCropper && rawImage && (
        <div className="fixed inset-0 z-[100] bg-black flex flex-col">
          <div className="shrink-0 flex items-center justify-between px-5 py-4 bg-black/80">
            <h3 className="text-white font-semibold text-base">{t("portfolioModal.adjustImage")}</h3>
          ...
          <div className="shrink-0 bg-black/90 px-5 pt-5 pb-[max(1.5rem,env(safe-area-inset-bottom))]">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <input type="range" title={t("profile.zoom")} min={1} max={3} step={0.05} value={zoom}
            ...
            <Button type="button" onClick={confirmCrop}
              ...
              {t("portfolioModal.confirmButton")}
            </Button>
          </div>
        </div>
      )}
